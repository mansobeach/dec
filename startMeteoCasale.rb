...
def startMeteoCasale
   cmd = "daemonME.rb -F -m \"triggerMeteoData.rb -F -D\" -i 59"
   ...
   cmd = "daemonME.rb -i 20 -m \"ddcDeliverFiles.rb\" "
# 
#    if @isDebugMode == true then
#       cmd = "#{cmd} -D"
#       puts cmd
...
#    end
   ...
   cmd = "daemonME.rb -F -i 900 -m \"genDailyMeteoFile.rb -F\" "
...
def stopMeteoCasale
   cmd = "daemonME.rb -s \"triggerMeteoData.rb -F\" "
   system(cmd)
