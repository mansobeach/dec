...
\inlinecode{bash}{ \$> decTestInterface_CelesTrak -n testTCA} \newline
...
\inlinecode{bash}{ \$> decTestInterface_CelesTrak -n testSFS} \newline
...
\inlinecode{bash}{ \$> decTestInterface_NASA -n testASTGTM }
...
\inlinecode{bash}{ \$> decTestInterface_NASA -n testRFM }
...
\inlinecode{bash}{ \$> decTestInterface_NASA -n testNBULA } \newline
...
\inlinecode{bash}{ \$> decTestInterface_NASA -n testNBULC } \newline
...
\inlinecode{bash}{ \$> decTestInterface_NASA -n testSFL } \newline
