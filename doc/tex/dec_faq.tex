...
\end{Verbatim}
		...
		\item[Pull data from SPCS / CSpOC seems slow?] Answer: space-track.org asks for a fair usage of interface to control their bandwidth costs and the pull operations using cURL are limited by using '--limit-rate 100K' according to their API.
		\newline
