...
\par
\inlinecode{bash}{ \$> \\curl -sSL https://get.rvm.io | bash -s stable }
...
\par
\inlinecode{bash}{ \$> gem install bundler }
...
\par
\inlinecode{bash}{ \$> bundle install }
...
\par
\inlinecode{bash}{ \$> gem install --local dec_stable.gem }
\par
