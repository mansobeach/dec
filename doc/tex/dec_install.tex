...
Different versions can be locally installed and select the one of choice at any time.

\inlinecode{bash}{ \$> rvm install ruby-2.6.5} \newline

\inlinecode{bash}{ \$> rvm --default use 2.6.5} \newline
