...
#
# CVS: $Id: ingesterComponent.rb,v 1.2 2009/01/26 17:24:57 algs Exp $
#
#########################################################################
...
def main
   ...
   # initialize logger
   loggerFactory = CUC::Log4rLoggerFactory.new("ingesterComponent", "#{@orcConfigDir}/orchestrator_log_config.xml")
