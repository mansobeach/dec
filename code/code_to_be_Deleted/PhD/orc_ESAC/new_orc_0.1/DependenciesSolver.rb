...
# 
# CVS: $Id: DependenciesSolver.rb,v 1.9 2009/03/18 08:27:13 decdev Exp $
#
# module ORC
#
#########################################################################
      ...
      if @coverMode == "NRT" and @isResolved == true then
         ...
         if @jobId != "0" then
            ...
            if trigger != nil then
               ...
               puts "inconsistency on the data base"
            end
         end
...
private
   ...
   def calculateTimeGMATRule
      ...
      afwdFile = @triggerFile.sub("REP", "MIR")
      ...
      if aRef != nil then
         ...
         puts
         cmd = "updateOrcProduct.rb -f #{@triggerFile} -s SUC"
         puts cmd
         system(cmd)
         return false
      end
