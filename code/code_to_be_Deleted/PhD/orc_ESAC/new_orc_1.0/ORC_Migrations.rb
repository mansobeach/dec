...
class CreateDiscardedTriggerProducts < ActiveRecord::Migration
   extend MigrationHelpers
   ...
   def self.up
      ...
      foreign_key(:discarded_trigger_products, :trigger_product_id, :trigger_products, 5)
   end
...
class CreateMessageParameters < ActiveRecord::Migration
   ...
   def self.up
      ...
      foreign_key(:message_parameters, :orchestrator_message_id, :orchestrator_messages, 6)
   end
