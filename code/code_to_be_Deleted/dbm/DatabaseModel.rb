...
class InventoryROPFileView < ActiveRecord::Base
   set_table_name 'ROP_FILE_VW'
end
#=====================================================================

class InventoryParams < ActiveRecord::Base
   set_table_name    'PARAMETERS_TB'
   set_primary_key   'KEYWORD'
end
#=====================================================================
