...
class WS_PlugIn_temperature_indoor
   ...
   def initialize(debug = false)
      @isDebugMode      = debug
      @variable         = "temperature_indoor"
      @unit             = "degrees Celsius"
      @failedThreshold  = ""     

      # ------------------------------------------
      # Edit the following lines to modify the thresholds 
      # applied to the variable temperature_indoor
   ...
   def setDebugMode
      @isDebugMode = true
      puts "WS_PlugIn_temperature_indoor debug mode is on"
   end
   #-------------------------------------------------------------
