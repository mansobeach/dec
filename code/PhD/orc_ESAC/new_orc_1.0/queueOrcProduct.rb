...
#
# CVS: $Id: queueOrcProduct.rb,v 1.16 2009/03/24 17:33:27 decdev Exp $
#
#########################################################################
...
# Global variables
@@dateLastModification = "$Date: 2009/03/24 17:33:27 $"   # to keep control of the last modification
                                       # of this script
   ...
   begin
      opts.each do |opt, arg|
         case opt      
            ...
            when "--version" then	    
               print("\nESA - DEIMOS-Space S.L. ", File.basename($0), " $Revision: 1.16 $  [", @@dateLastModification, "]\n\n\n")
               exit(0)
...
def list
   ...
   if @bDiscarded == true then
      ...
      discardedFiles  = DiscardedTriggerProduct.find(:all,
                                    :order => "discarded_date")
