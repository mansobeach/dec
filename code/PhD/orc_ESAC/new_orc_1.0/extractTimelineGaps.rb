...
#
# CVS: $Id: extractTimelineGaps.rb,v 1.2 2009/02/10 09:58:43 decdev Exp $
#
#########################################################################
...
# Global variables
@@dateLastModification = "$Date: 2009/02/10 09:58:43 $"   # to keep control of the last modification
                                       # of this script
...
def main
   ...
   if (@full_report_name == "" or @full_report_name.slice(0,1) != "/") and @bList == false then
      puts
   ...
   if @isDebugMode == true then
      puts "Registered Timelines:"
      i = 1
      arrTimeLines.each{|aTimeline|
         print "[#{i}] - ", aTimeline.file_type, " - ", aTimeline.sensing_start, " - ",  aTimeline.sensing_stop, "\n"
      }
   end
