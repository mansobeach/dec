...
#########################################################################
#
# === Wrapper for Ruby to xv_station_vis_time CFI by DEIMOS Space S.L.U.      
#
                                          ...
                                          ) 
{
   ...
   if (iDebug == 1)
   {
      printf("DEBUG: ENTRY ruby_xv_stationvistime_compute::method_xv_stationvistime_compute\n") ;  
   }
   
   Check_Type(strOutFile, T_STRING) ;
   ...
   {
      printf("\n") ;
      printf("startOrbit => %i \n", NUM2ULONG(startOrbit) ) ;
      printf("endOrbit   => %i \n", NUM2ULONG(endOrbit) ) ;
      printf("strOutFile => %s \n", StringValueCStr(strOutFile) ) ;
      printf("\n") ;
   }
   ...
   */
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI2 BEFORE => xv_swath_id_init \n") ; 
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI3 AFTER => xv_swath_id_init \n") ; 
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI4 AFTER => xv_swathpos_compute \n") ; 
   ...
   */
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI5 BEFORE => xv_stationvistime_compute \n") ; 
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI6 AFTER => xv_stationvistime_compute \n") ; 
   ...
   for(i=0; i <  sta_vis_list.num_rec; i++)
   {
      ...
      if (iDebug == 1)
         printf("\nHASTA AQUI7 AFTER => xf_tree_add_child \n") ; 
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI8 AFTER => xf_tree_create_header \n") ; 
   ...
   */
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI9 BEFORE => strftime \n") ; 

   strftime(creation_date, 19, "%Y-%m-%dT%H:%M:%S", tm_info) ;
   
   if (iDebug == 1)
      printf("\nHASTA AQUI9 AFTER => strftime \n") ; 
   ...
   if (iDebug == 1)
      printf("\nHASTA AQUI10 AFTER => xf_tree_write \n") ; 
   ...
   if (iDebug == 1)
   {
      printf("DEBUG: EXIT ruby_xv_stationvistime_compute::method_xv_stationvistime_compute\n") ;  
   }
