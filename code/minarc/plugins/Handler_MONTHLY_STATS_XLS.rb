...
#
# MONTHLY_STATS_<VARIABLE>_XLS_<STATIONID> 
# MONTHLY_STATS_<VNAME1-VNAME2>_XLS_<STATIONID> 
#
# Example name : MONTHLY_STATS_TEMPERATURE-OUTDOOR_XLS_CASALE_201302.xls
...
class Handler_MONTHLY_STATS_XLS
   @type             = ""
   @filename         = ""
   @validated        = false
   @start            = nil
   ...
   def initialize (name, destination = nil)
      ...
      if name.include?("MONTHLY_STATS") and name.include?(".xls") == true then
