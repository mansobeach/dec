...
void Init_ruby_explorer_orbit()
{
   ...
   ruby_explorer_orbit  = rb_define_class_under(mpl, "Explorer_Orbit", rb_cObject) ;
	...
	rb_define_method(ruby_explorer_orbit, "check_library_version", method_check_library_version, 0) ;
...
{
   printf("\n") ;
   printf("DEBUG: entry ruby_explorer_orbit::method_check_library_version\n") ;  
   printf("\n") ;
