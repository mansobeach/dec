...
typedef enum
{
   XV_CFI_STATIONVISTIME_COMPUTE_ORBIT_STATUS_ERR = XL_ZERO_E,
   XV_CFI_STATIONVISTIME_COMPUTE_GEO_SAT_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_SWATH_STATUS_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_INPUTS_CHECK_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_ORBIT_TYPE_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_SWATH_FLAG_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_FIRST_ORBIT_WARN,
   XV_CFI_STATIONVISTIME_COMPUTE_REL_TO_ABS_START_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_WRONG_INTERVAL_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_WRONG_SWATH_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_SWATH_TYPE_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_ORBIT_INFO_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_INCONSISTENT_SWATH_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_ORBIT_CHANGE_WARN,
   XV_CFI_STATIONVISTIME_COMPUTE_STA_COMPUTE_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_SEGMENTS_MEMORY_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_ABS_TO_REL_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_ORBIT_MODEL_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_READ_SWATH_FILE_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_ORBIT_INTERVAL_STF_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_ORBIT_INTERVAL_STF_WARN,
   XV_CFI_STATIONVISTIME_COMPUTE_OSF_NON_LIN_STF_OLD_WARN,
   XV_CFI_STATIONVISTIME_COMPUTE_OVERLAP_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_SWATH_FLAG_LARGER_THAN_LIN_APPROX_VAL_WARN,
   XV_CFI_STATIONVISTIME_COMPUTE_TIME_TO_ORBIT_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_CHECK_SEGMENTS_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_GET_UTC_TIME_ERR,
   
   XV_CFI_STATIONVISTIME_COMPUTE_DETECT_SWATH_TYPE_ERR = XL_FIRST_E,
   XV_CFI_STATIONVISTIME_COMPUTE_PRECISE_PROPAG_WARN,
   XV_CFI_STATIONVISTIME_COMPUTE_ATTITUDE_TYPE_ERR,
   XV_CFI_STATIONVISTIME_COMPUTE_LINK_ID_ERR // AN-573
