...
typedef enum
{
  XL_ANGLE_TYPE_TRUE_LAT_TOD= 1,
  XL_ANGLE_TYPE_MEAN_LAT_TOD,
...
long xl_time_close(xl_time_id * time_id, long ierr[]);
...
typedef enum
{
  ...
  XL_CFI_TIME_REF_INIT_FILE_IERS_B_A_WRONG_ERR,
  XL_CFI_TIME_REF_INIT_FILE_IERS_B_A_BIG_GAP_ERR,
