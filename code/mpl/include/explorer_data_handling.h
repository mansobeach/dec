...
typedef enum
{
  XD_CFI_READ_ZONE_INIT_PARSER_ERR = XD_ZERO_E,
  XD_CFI_READ_ZONE_DATA_BLOCK_ERR,
  XD_CFI_READ_ZONE_DATA_BLOCK_ATTRIBUTE_ERR,
  XD_CFI_READ_ZONE_XML_TYPE_ERR,
  XD_CFI_READ_ZONE_LIST_ZONES_READ_ERR,
  XD_CFI_READ_ZONE_LIST_ZONES_SIZE_ERR,
  XD_CFI_READ_ZONE_INTERNAL_1_ERR,
...
typedef enum
{
  XD_CFI_READ_ZONE_FILE_INIT_PARSER_ERR = XD_ZERO_E,
  XD_CFI_READ_ZONE_FILE_DATA_BLOCK_ERR,
  XD_CFI_READ_ZONE_FILE_DATA_BLOCK_ATTRIBUTE_ERR,
  XD_CFI_READ_ZONE_FILE_XML_TYPE_ERR,
  XD_CFI_READ_ZONE_FILE_LIST_ZONES_READ_ERR,
  XD_CFI_READ_ZONE_FILE_LIST_ZONES_SIZE_ERR,
  XD_CFI_READ_ZONE_FILE_MEM_ERR,
...
typedef enum
{
  XD_CFI_READ_ZONE_ID_INIT_PARSER_ERR = XD_ZERO_E,
  XD_CFI_READ_ZONE_ID_DATA_BLOCK_ERR,
  XD_CFI_READ_ZONE_ID_LIST_ZONES_READ_ERR,
  XD_CFI_READ_ZONE_ID_LIST_ZONES_SIZE_ERR,
  XD_CFI_READ_ZONE_ID_MEMORY_ERR,
...
typedef enum
{
  ...
  XD_CFI_WRITE_ORBIT_FILE_CREATE_NODE_ERR,
  XD_CFI_WRITE_ORBIT_FILE_GET_ASCII_TIME_ERR,
  XD_CFI_WRITE_ORBIT_FILE_WRITE_ERR,
  XD_CFI_WRITE_ORBIT_FILE_GOTO_NODE_ERR,
  XD_CFI_WRITE_ORBIT_FILE_SET_SCHEMA_WARN,
  XD_CFI_WRITE_ORBIT_FILE_REF_FRAME_ERR,
  XD_CFI_WRITE_ORBIT_FILE_TIME_REF_OF_ERR
...
typedef enum
{
  ...
  XD_CFI_WRITE_OSF_CREATE_NODE_ERR,
  XD_CFI_WRITE_OSF_SET_NODE_VALUE_ERR,
  XD_CFI_WRITE_OSF_TIME_TO_EXTERNAL_ERR,
  XD_CFI_WRITE_OSF_WRITE_ERR,
  XD_CFI_WRITE_OSF_SET_SCHEMA_WARN,
  XD_CFI_WRITE_OSF_TIME_REF_OF_ERR
} XD_CFI_write_osf_err_enum;

/* Error codes list of xd_write_stf */
typedef enum
{
  XD_CFI_WRITE_STF_CREATE_XML_ERR = XD_ZERO_E,
  XD_CFI_WRITE_STF_CREATE_ROOT_XML_ERR,
  XD_CFI_WRITE_STF_XD_FHR_WRITE_ERR,
  XD_CFI_WRITE_STF_XD_STF_VHR_WRITE_ERR,
  XD_CFI_WRITE_STF_CREATE_NODE_XML_ERR,
  XD_CFI_WRITE_STF_WRONG_SWATH_TYPE_ERR,
  XD_CFI_WRITE_STF_WRITE_REC_ERR,
...
typedef enum
{
  ...
  XD_CFI_WRITE_PRECISE_PROPAG_CREATE_NODE_ERR,
...
typedef enum
{
  ...
  XD_CFI_ORBIT_FILE_DIAGNOSTICS_READ_ORBIT_FILE_ERR,
  XD_CFI_ORBIT_FILE_DIAGNOSTICS_READ_DORIS_ERR,
  XD_CFI_ORBIT_FILE_DIAGNOSTICS_READ_OEM_ERR,
  XD_CFI_ORBIT_FILE_DIAGNOSTICS_READ_SP3_ERR,
  XD_CFI_ORBIT_FILE_DIAGNOSTICS_COMPUTE_DIAGNOSTICS_ERR,
  XD_CFI_ORBIT_FILE_DIAGNOSTICS_WRONG_FILE_TYPE_ERR,
...
typedef struct
{
  long type; // XD_Fov_constraints_enum
