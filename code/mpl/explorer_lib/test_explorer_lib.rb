...
require './ruby_explorer_lib'

require 'test/unit'
require 'cuc/Converters'

class TestCase_ExplorerLib < Test::Unit::TestCase
   ...
   Test::Unit.at_start do      
      puts
      puts "======================================"
      puts "MPL Explorer_Lib Unit Test Cases"
      puts
      puts
   ...
   Test::Unit.at_exit do
      puts "End of MPL Explorer_Lib Unit Test Cases"
   end
