#########################################################################
#
# === Wrapper for Ruby to EXPLORER_LIB CFI by DEIMOS Space S.L.U.      
#
...
libs = ['-lxml2', '-lexplorer_data_handling', '-lexplorer_file_handling', '-lexplorer_lib']

dir_config('explorer_lib', HEADER_DIRS, LIB_DIRS)
...
create_makefile('ruby_explorer_lib')
