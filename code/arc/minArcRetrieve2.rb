...
def main
   ...
   if showVersion then 
      ...
      sInversion = aFile.gets.chomp

      puts
      puts "Mini-Archive Component - Version #{sInversion}"
      puts
   ...
   if @filename != "" and @filetype != "" and bGetAllFiles == false then
      usage
   end
