...
#     --filename <chart_name> output filename with extension
...
require 'getoptlong'
require 'rdoc/usage'
require 'ws23rb/CharterFromWSExcelFile2'
...
#   if (@prefixName == nil and @outputFilename == nil) or
#      (@prefixName != nil and @outputFilename != nil) then
#      RDoc::usage("usage")
#   end
...
def performProcessing
   parser = WS23RB::CharterFromWSExcelFile.new(@excelName, @prefixName, @outputFilename, @isDebugMode)
