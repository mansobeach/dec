...
# R A S P B E R R Y  P I  V E R S I O N
...
def main
   ...
   cmd = "mv #{meteoFilename} METEO_CASALE.xml"

   if @bHistoric == true then
      cmd = "mv #{meteoFilename} METEO_HISTORIC.xml"
   end


   system(cmd)

   cmd = "\\mv -f METEO_CASALE.xml ../data/outtray/ftp"

   if @bHistoric == true then
      cmd = "\\mv -f METEO_HISTORIC.xml ../data/outbox/METEO"
   end
