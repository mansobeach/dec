#!/bin/bash
# Start/stop the meteo_casale daemon.
#
### BEGIN INIT INFO
# Provides:          meteo_casale
...
DESC="meteo_casale daemon"
NAME=startup_meteo_casale.sh
echo
echo "Casale & Beach - Meteo Casale service"
echo
fortune
echo
echo

# su - pi -c 'daemonME.rb -D -i 29 -m triggerMeteoData.rb'
su - pi -c 'daemonME.rb    -i 29 -m triggerMeteoData.rb'
echo

exit

#cd /home/pi/Projects/weather/config
#pwd
#su - pi -c 'echo $METEO_BASE'
#
#echo


source  profile_weather
...
PIDFILE=/var/run/meteo_casale.pid
