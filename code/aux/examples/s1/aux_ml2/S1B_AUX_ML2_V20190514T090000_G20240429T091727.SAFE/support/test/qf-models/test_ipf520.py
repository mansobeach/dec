...
def test_quality_flag():
    ...
    assert np.allclose(np.array([0.73062086]), y_err_pred_Hs)
    assert np.allclose(np.array([0.24374418]), y_err_pred_Wl)
    assert np.allclose(np.array([30.483728]), y_err_pred_Phi)
